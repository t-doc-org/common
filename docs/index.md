...
the [t-doc.org](https://t-doc.org/) site. It is distributed as a single Python
...
- **[Sphinx](https://www.sphinx-doc.org/):** A documentation generation system,
  ...
  - **[Sphinx Book Theme](https://sphinx-book-theme.readthedocs.io/):** A Sphinx
    theme based on the
...
- **[Pyodide](https://pyodide.org/):** A Python distribution for the browser
  based on [WebAssembly](https://webassembly.org/), integrated via
  [Polyscript](https://pyscript.github.io/polyscript/).
- **[SQLite WASM](https://sqlite.org/wasm/):** A build of
  [SQLite](https://sqlite.org/) to [WebAssembly](https://webassembly.org/).
